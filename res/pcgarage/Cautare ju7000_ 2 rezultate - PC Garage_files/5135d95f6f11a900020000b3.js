...
_pa.segments = [{"name":"SSD","id":862857,"regex":"/ssd/.*/?([?#].*)*$"},{"name":"Multifunctionale","id":1050301,"regex":"/multifunctionale/.*/?([?#].*)*$"},{"name":"Vizitatori convertiti","id":653794,"regex":"/confirmare.*/?([?#].*)*$"},{"name":"Laptopuri Dell","id":1293638,"regex":"/notebook\\-laptop/dell/.*/?([?#].*)*$"},{"name":"Tablete General","id":624297,"regex":"/tablete/.*/?([?#].*)*$"},{"name":"Mouse gaming","id":1079877,"regex":"/mouse\\-gaming/.*/?([?#].*)*$"},{"name":"Vizitatori recenti","id":653793,"regex":".*"},{"name":"All visitors","id":624267,"regex":".*"},{"name":"Casti gaming","id":1079880,"regex":"/casti\\-gaming/.*/?([?#].*)*$"},{"name":"Tablete copii","id":815438,"regex":"\\?.*utm_campaign=tablete\\-copii"},{"name":"Cos creat","id":931517,"regex":"/cos/?([?#].*)*$"},{"name":"Monitoare LED","id":665973,"regex":"/monitoare.*/?([?#].*)*$"},{"name":"Tastaturi gaming","id":1079879,"regex":"/tastaturi\\-gaming/.*/?([?#].*)*$"},{"name":"Creat wishlist","id":931527,"regex":"/adauga\\-wishlist.*/?([?#].*)*$"},{"name":"Laptop","id":634001,"regex":"/notebook\\-laptop/.*/?([?#].*)*$"},{"name":"Televizoare","id":653220,"regex":"/televizoare.*/?([?#].*)*$"},{"name":"HDD Externe","id":653221,"regex":"/hard\\-disk\\-uri\\-externe/.*/?([?#].*)*$"},{"name":"Smartphone","id":653222,"regex":"/smartphone/.*/?([?#].*)*$"},{"name":"NAS","id":1293823,"regex":"/nas/.*/?([?#].*)*$"},{"name":"Scaune gaming","id":4042205,"regex":"/scaune\\-gaming.*/?([?#].*)*$"}];
_pa.conversions = [{"name":"Comanda","id":"70419","regex":"/confirmare//?([?#].*)*$"}];
_pa.conversionEvents = [];
_pa.segmentEvents = [];
_pa.thirdPartyTags = [];
_pa.thirdPartyTagEvents = [];
_pa.allVisitorsSegmentId = 624267;
_pa.clickThroughWindow = 30;
_pa.viewThroughWindow = 30;
_pa.rtbId = '1002';
_pa.siteId = '5135d95f6f11a900020000b3';
